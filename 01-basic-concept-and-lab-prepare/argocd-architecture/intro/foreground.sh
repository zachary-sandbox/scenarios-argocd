...
# ArgoCD Login Url
ARGOCD_URL=$(echo "https://cdac3975fe6801fc-1-PORT.papa.r.killercoda.com" | sed 's/PORT/30080/')
...
argocd login "$ARGOCD_URL" --username admin --password 85JpZdUMOUWMzcJ4 --insecure --grpc-web
