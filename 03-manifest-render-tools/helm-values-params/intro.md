### Lab Module: helm-values-params Helm Values and Parameters
🎯 Module Objectives
1. Use values.yaml to customize Helm chart rendering
2. Override Helm parameters in Argo CD Application spec
